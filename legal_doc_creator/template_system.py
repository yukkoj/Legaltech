...
My agent is authorized to make all health care decisions for me, including decisions to provide, withhold, or withdraw life-sustaining treatment. 
My agent is also authorized to have access to, obtain, inspect, copy, and disclose any and all of my health care information and medical records, to the extent permitted by California law, and to speak with my health care providers on my behalf. 
This authority includes information relating to my diagnosis, treatment, prognosis, and other protected health information.
...
PART IV: CONDITION-SPECIFIC INSTRUCTIONS
...
{% else %}
I wish to be fully informed of my medical condition, diagnosis, prognosis, and the risks and benefits of proposed treatments.
{% endif %}
...
{% endif %}
I authorize my healthcare agent named in Part I to carry out these instructions regarding my remains.
{% endif %}
